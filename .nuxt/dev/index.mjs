globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/Jay/Documents/CMGT/Jaar%203/PLE/queerly-optimistic/node_modules/node-fetch-native/dist/polyfill.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/Jay/Documents/CMGT/Jaar 3/PLE/queerly-optimistic","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/Jay/Documents/CMGT/Jaar 3/PLE/queerly-optimistic/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/Jay/Documents/CMGT/Jaar 3/PLE/queerly-optimistic/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/Jay/Documents/CMGT/Jaar 3/PLE/queerly-optimistic/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_9cVkju = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_9cVkju, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_9cVkju, lazy: true, middleware: false, method: undefined }
];
